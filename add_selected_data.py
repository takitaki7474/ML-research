...
parser.add_argument("--fe_stage", "-stage", type=int, default=1)
...
#特徴量のステージをもとに次に追加するデータを選択
add_data_name = add_data_lib.add_data_select(add_num_df, fe_stage, data_num)
